...
summon area_effect_cloud ~ ~ ~ {Particle:"item_slime",Radius:1f,RadiusPerTick:.1f,Duration:40,Effects:[{Id:9b,Amplifier:1b,Duration:100},{Id:19b,Amplifier:1b,Duration:100},{Id:20b,Amplifier:1b,Duration:100}]}
